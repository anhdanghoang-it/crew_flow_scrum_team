...
1. **Requirements Document**
   - Exactly ONE raw requirements document must be provided as a context file attachment (typically named `requirements.md` or similar)
   - This document contains the original business requirements and specifications
   - Must be available in context before starting the technical design process
...
2. **User Stories Document**
   ...
   - Defines UI/UX requirements and user-facing messages
   - Must be available in context before starting the technical design process
